                                ...
                                <div class = "col-lg-12 col-md-12">
                                    <div class = "card">
                                        <div class="card-header" data-background-color="blue">
                                            <h4 class="title">Alterar valor</h4>
                                            <p class="category">A alteração do valor altera também todos os calculos dos relatórios em que este item é referido.</p>
                                        </div>
                                        ...
                                        <div class="card-content">
                                            ...
                                            echo "
                                            <form method='POST' action='alterando_valor_patrimonio.php'>
                                            <input type='hidden' name='idpatrimonio' value='$idpatrimonio' />
                                            Registro:  $exibe[registro] <br>
                                            Descrição: $exibe[descricao] <br> 
                                            Valor atualmente cadastrado: $exibe[valor_compra] <br> 
                                            Novo valor: <input type='text' name='novo_valor' value='' />";?>
                                        </div>    
