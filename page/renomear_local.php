                                ...
                                <div class = "col-lg-12 col-md-12">
                                    <div class = "card">
                                        <div class="card-header" data-background-color="blue">
                                            <h4 class="title">Renomear Local</h4>
                                            <p class="category">Digite o novo nome e grave.</p>
                                        </div>
                                        ...
                                        <div class="card-content">
                                            ...
                                            $qr = "select * from local where idlocal like $idlocal;";
                                            $select_local = mysqli_query($connect, $qr) or die(msql_error());
                                            $exibe = mysqli_fetch_assoc($select_local);
                                            
                                            echo "
                                            <form method='POST' action='renomeando_local.php'>
                                            <input type='hidden' name='idlocal' value='$idlocal' />
                                            id: " . $exibe[idlocal] . "<br>
                                            Nome do local: <input type='text' name='novo_nome' id='novo_nome' placeholder='Novo nome' value='$exibe[descricao]'> <br> 
